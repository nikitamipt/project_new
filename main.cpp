...
#include "source/Game_war_DETBot.cpp"
#include "source/Game_war_NETBot.cpp"
//#include "source/Game_war_NET_DET.cpp"
...
int main()
{
    ...
    while (j) {
        ...
        else if (i == 4) { Game_war_DETBot();   j = 0;}
      //  else if (i == 5) { Game_war_NET_DET();  j = 0;}
        else if (i == 0) { j = 0;}
        else {
